...
type
  ...
  TKf = class(TForm)
    ...
    dZn3: TFloatSpinEdit;
    dZn4: TFloatSpinEdit;
    gCaNO4: TFloatSpinEdit;
    gCaNO5: TFloatSpinEdit;
    gCaNO6: TFloatSpinEdit;
    gCaNO7: TFloatSpinEdit;
    gCmplx: TFloatSpinEdit;
    gB: TFloatSpinEdit;
    gCo: TFloatSpinEdit;
    gCu: TFloatSpinEdit;
    gFe: TFloatSpinEdit;
    gK2SO5: TFloatSpinEdit;
    gK2SO6: TFloatSpinEdit;
    gK2SO7: TFloatSpinEdit;
    gK2SO8: TFloatSpinEdit;
    gKH2PO5: TFloatSpinEdit;
    gKH2PO6: TFloatSpinEdit;
    gKH2PO7: TFloatSpinEdit;
    gKH2PO8: TFloatSpinEdit;
    gKNO4: TFloatSpinEdit;
    gKNO5: TFloatSpinEdit;
    gKNO6: TFloatSpinEdit;
    gKNO7: TFloatSpinEdit;
    gMgNO4: TFloatSpinEdit;
    gMgNO5: TFloatSpinEdit;
    gMgNO6: TFloatSpinEdit;
    gMgNO7: TFloatSpinEdit;
    gMgSO5: TFloatSpinEdit;
    gMgSO6: TFloatSpinEdit;
    gMgSO7: TFloatSpinEdit;
    gMgSO8: TFloatSpinEdit;
    gMn: TFloatSpinEdit;
    gMo: TFloatSpinEdit;
    gNH4NO4: TFloatSpinEdit;
    gNH4NO5: TFloatSpinEdit;
    gNH4NO6: TFloatSpinEdit;
    gNH4NO7: TFloatSpinEdit;
    gSi: TFloatSpinEdit;
    gZn: TFloatSpinEdit;
    Fe: TFloatSpinEdit;
    B: TFloatSpinEdit;
